$(document).ready(function() {
                  ...
                  G.innerHTML = "Pos:&nbsp;" + E + ", " + C + "&nbsp;&nbsp;Color:&nbsp;0x" + n(v, B, D) + "&nbsp;&nbsp;RGB:&nbsp;(" + v + "," + B + "," + D + ")";
                  ...
                  setupWebViewJavascriptBridge(function(bridge) {
                                               ...
                                               bridge.registerHandler('imgData', function(data, responseCallback) {                                                                      
